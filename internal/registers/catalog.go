...
func Catalog() []Register {
	return []Register{
		...
		{
			ID:          "last_switch_to_grid_at",
			Name:        "Last Switch To Grid At",
			Address:     0xFFF2,
			Count:       0,
			Type:        TypeUint16,
			Synthetic:   true,
		...
		{
			ID:          "last_switch_to_grid_soc",
			Name:        "Last Switch To Grid SOC",
			Address:     0xFFF3,
			Count:       0,
			Type:        TypeUint16,
			Synthetic:   true,
		...
		{
			ID:          "last_switch_to_battery_at",
			Name:        "Last Switch To Battery At",
			Address:     0xFFF4,
			Count:       0,
			Type:        TypeUint16,
			Synthetic:   true,
		...
		{
			ID:          "last_switch_to_battery_soc",
			Name:        "Last Switch To Battery SOC",
			Address:     0xFFF5,
			Count:       0,
			Type:        TypeUint16,
			Synthetic:   true,
		...
		{
			ID:          "battery_charge_energy_total_estimate",
			Name:        "Battery Charge Energy Total Estimate",
			Address:     0xFFF6,
			Count:       0,
			Type:        TypeUint16,
			Synthetic:   true,
		...
		{
			ID:          "battery_discharge_energy_total_estimate",
			Name:        "Battery Discharge Energy Total Estimate",
			Address:     0xFFF7,
			Count:       0,
			Type:        TypeUint16,
			Synthetic:   true,
